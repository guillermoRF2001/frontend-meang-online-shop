...
export class CartService {
  ...
  public clearItems = new Subject<boolean>();
  public clearItems$ = this.clearItems.asObservable();
  constructor() { }
  ...
  public updateCartEmpty(newValue: boolean) {
    this.clearItems.next(newValue);
  }
